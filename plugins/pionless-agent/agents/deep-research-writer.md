...
- **`|` in prose** — even though tables are banned, if a draft slipped one in or a sentence contains a literal `|`, escape internal pipes as `\|` before converting to definition-list form.
